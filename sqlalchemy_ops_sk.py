...
import itertools
import re
# import pccm_db_curation.patient_info_variable_dicts as dict_values
import helper_function.table_dicts as td

# folder = 'D:/Shweta/pccm_db'
file = 'sqlite:///D://Shweta//pccm_db//PCCM_BreastCancerDB_2021_02_22.db'
folder = '/home/arthur/repos/pccm_db_update/main/DB'
db_name = 'PCCM_DB_2022_05_26.db'
db_location = os.path.join(folder, db_name)
...
# it gives col names of table
print(inspector.get_columns('physical_activities'))
...
phy_act_data = patient_info[['file_number', 'physical_activity_y_n',
            ...
            if len(vocab_type) != 0:
                ...
                for value in split_val:
                    ...
                    key_reqd = get_value_from_key(
                        physical_activity_dict, cleaned_value)
...
changed_phy_act, lst = repalce_values_by_dict_keys(
    physical_activity_dict, vals_dict)
