...
physical_activity_dict = {'walking': ['walk', 'walking', 'walking_for_exercise', 'lawn_walking', 'lawn moving', 'lawn mowing',
                             ...
                             'exercise': ['exercise'],
                             'lower_intensity_exercise': ['lower intensity exercise', 'intensity'],
...
strings = 'daily exercise and yoga'
splitted_strings = []
